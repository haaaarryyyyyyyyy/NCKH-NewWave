...
var valueTemp = firebase.database().ref('DoAm');
valueTemp.on('value', snap => {
...
// valueTemp.on('value', snap => {
//   console.log("NhietDo: " + snap.val());
//   document.getElementById("displayNhietDo").innerText = "Nhiệt Độ: " + snap.val() + " °C";
// });

// var valueHumidity = firebase.database().ref('status/humidity');
// valueHumidity.on('value', snap => {
//   console.log("DoAm: " + snap.val());
//   document.getElementById("displayDoAm").innerText = "Độ Ẩm: " + snap.val() + " %";
// });
